...
import { Building, ClipboardList, Clock, CheckCircle, CheckSquare, XCircle, DollarSign, Star, Users, UserCircle, User } from "lucide-react";
import { adminOverview } from "./_actions/adminActions";
...
export default async function AdminDashboardOverview() {
    ...
    const statCards = [
        ...
        },
        {
            title: "Total Tenants",
            value: totalTenants,
            icon: <UserCircle className="h-7 w-7 text-cyan-600" />,
            bgColor: "bg-cyan-50"
        },
        {
            title: "Total Landlords",
            value: totalLandlords,
            icon: <User className="h-7 w-7 text-pink-600" />,
            bgColor: "bg-pink-50"
        },
        {
        ...
        <div className="space-y-8">
            <div>
                ...
                <p className="text-muted-foreground mt-1">
                    System-wide metrics including users, properties, requests, and revenue.
                </p>
            </div>
